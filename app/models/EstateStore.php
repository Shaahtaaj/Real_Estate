...
class EstateStore
{
    ...
    public static function upsertProperty(array $input, ?string $slug = null, array $uploadedImages = []): array
    {
        ...
        $image = $images[0]['webp'] ?? trim($input['image'] ?? '') ?: ($existing['image'] ?? 'assets/images/property-1.svg');
